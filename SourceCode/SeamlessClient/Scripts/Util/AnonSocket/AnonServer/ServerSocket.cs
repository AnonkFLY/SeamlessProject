...
namespace AnonSocket.AnonServer
{
    public class ServerSocket : IDisposable
    {
        ...
        public Client[] Clients { get => _clients; }
        ...
        private void OnAccept(IAsyncResult result)
        {
            ...
            if (index == -1)
                return;
            var client = GetNewClient(clientSocket, index);
        ...
        private Client GetNewClient(Socket socket, int index)
        {
            return new Client(index, this, socket, _bufferSize);
